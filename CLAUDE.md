...
> **📋 ЖИВОЙ ПЛАН — `STATUS.md` в корне.** В начале сессии прочитать его (что в проде / хвосты / бэклог). В конце сессии или после закрытого блока — ОБНОВИТЬ: двигать строки в «Сделано», править дату/версию сверху. Это единый источник «что осталось» — Павел не должен держать это в голове.
