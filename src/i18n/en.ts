export const en = {
  ...
  settings: {
    ...
    updatesHint: 'Version from GitHub (frolofpavel/verstak). Download and install run in the background — Verstak restarts automatically. If stuck — Clear update cache.',
  ...
  updates: {
    ...
    availableReady: 'Version {version} downloaded — installing in the background and restarting.',
    later: 'Later',
    downloadingBar: 'Downloading update v{version}… {percent}%',
    readyBar: 'Installing v{version}…',
