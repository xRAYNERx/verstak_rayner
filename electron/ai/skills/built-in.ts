...
**Левая колонка (rail):** список проектов, кнопка «+» (новый клиент), поиск, скрытые проекты. Внизу: обновления, **Настройки** и **?** — **глобальная справка**, отдельно от любого проекта (индикатор ответа на «?», не на папке клиента).
