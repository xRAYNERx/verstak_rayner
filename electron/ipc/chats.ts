...
export function registerChatsIpc(chats: Chats, sessions: ChatSessions, db: Database): void {
  ...
  ipcMain.handle('chats:list-window', (_e, sessionId: number, opts?: { limit?: number; beforeId?: number; includeThinking?: boolean }) =>
    chats.listWindowBySession(sessionId, opts)
  )
